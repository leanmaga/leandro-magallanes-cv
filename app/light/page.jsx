...
import { FaSun, FaMoon,  FaGamepad, FaBook,FaPhoneAlt, FaEnvelope, FaGlobe, FaLinkedin, FaMapMarkerAlt  } from 'react-icons/fa';
          ...
          <div className={`right_Side ${darkMode ? 'bg-[#003147] text-white' : 'bg-white text-black'} p-10 relative z-10 w-[800px]`}>
              ...
              <div className="about interest p-10">
                  ...
                  <ul>
                    ...
                    <li className="text-[#03a9f4] uppercase flex items-center">
